...
function useCollection(memoizedTargetRefOrQuery) {
        ...
        "useCollection.useEffect": ()=>{
            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(memoizedTargetRefOrQuery, {
                ...
                "useCollection.useEffect.unsubscribe": (serverError)=>{
                    // Safe path extraction: Check if it's a CollectionReference or a Query
                    const path = memoizedTargetRefOrQuery.path || 'query-path';
    ...
    if (memoizedTargetRefOrQuery && !memoizedTargetRefOrQuery.__memo) {
        throw new Error('Query must be memoized using useMemoFirebase');
    }
    return {
        data,
        isLoading,
...
const TickerTape = ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "w-full bg-black/90 backdrop-blur-md border-b border-white/5 h-[44px] overflow-hidden",
        ref: containerRef,
...
_s(TickerTape, "Nf8A3lEhHVfrobUYGOKkjoGfjR0=");
_c = TickerTape;
var _c;
...
//# sourceMappingURL=src_d1fe7a3d._.js.map