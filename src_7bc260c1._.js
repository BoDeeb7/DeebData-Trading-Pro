...
const AdminPanel = (param)=>{
    ...
    const handleSearchUser = async ()=>{
        ...
        try {
            ...
            // For this prototype, we'll search by iterating through known structures or querying profiles
            const results = [];
        ...
        const mockSignals = [
            {
                ...
                tp: 2045.00,
                sl: 2012.00,
                reason: 'Demand at key Fibonacci level.'
            },
            {
                asset: 'BTCUSD',
                direction: 'Sell',
                ...
                tp: 48500,
                sl: 53000,
                reason: 'RSI divergence detected on H4.'
            },
            {
                asset: 'EURUSD',
                direction: 'Buy',
        ...
        "DashboardPage.useEffect": ()=>{
            ...
            const seedAnalystData = {
                "DashboardPage.useEffect.seedAnalystData": async ()=>{
                    console.log("[ADMIN] Triggering automatic Analyst Feed seed...");
                    const mockSignals = [
                        {
                            asset: 'XAUUSD',
                            direction: 'Buy',
                            ...
                            tp: 2045.00,
                            sl: 2010.00,
                            reason: 'Demand at key Fibonacci level (H4).'
                        },
                        {
                            asset: 'BTCUSD',
                            direction: 'Sell',
                            ...
                            tp: 48500,
                            sl: 53000,
                            reason: 'RSI divergence detected on 4-hour chart.'
                        },
                        {
                            asset: 'EURUSD',
                            direction: 'Buy',
                            ...
                            tp: 1.0950,
                            sl: 1.0800,
                            reason: 'ECB hawkish sentiment favoring Euro.'
                        }
                    ];
                    try {
                        for (const sig of mockSignals){
...
//# sourceMappingURL=src_7bc260c1._.js.map